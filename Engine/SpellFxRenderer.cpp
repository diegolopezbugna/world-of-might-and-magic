...
int SpellFX_Billboard::SpellFXFarClipAdjust(float farclip) { // far clip adjust - needs diffuse sorting properly??
    ...
    //SpellFX_Billboard *v35;  // [sp+C0h] [bp-18h]@1
    ...
    //    while (1) {
    //        v5 = v4 - 15;
    //        if (*(float *)(v4 - 15) >= (double)farclip &&
    //            *(float *)(v4 + 1) >= (double)farclip) {
    //            v4 += 16;
    //            --v34;
    //            if (!v34) return this->uNumVertices = v38;
    //            continue;
    //        }
    //        if (*(float *)v5 >= (double)farclip) {
    //            v6 = (farclip - *(float *)v5) / (*(float *)(v4 + 1) - *(float *)v5);
    ...
    //            // this = v35;
    //            v5 = (char *)&v30 + 4;
    //        } else if (*(float *)(v4 + 1) >= (double)farclip) {
    //            v15 = (farclip - *(float *)v5) / (*(float *)(v4 + 1) - *(float *)v5);
    //            v16 = (unsigned __int8)*v4;
    //            HEXRAYS_HIDWORD(v30) = HEXRAYS_LODWORD(farclip);
...
int SpellFX_Billboard::SpellFXProject() {  // project to billboard coords
    ...
    for (int i = 0; i < this->uNumVertices; i++) {
        ...
        if (true/*(double)(signed int)pViewport->uViewportTL_X <=
                field_104[i].x &&
